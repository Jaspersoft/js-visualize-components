...
export type CardProps = MuiCardProps & {
  ...
  paddedCardBodyContent?: ReactNode;
};
...
export const CustomizableCard = forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    return (
      <MuiCard
        ref={ref}
        className={`jv-mCard ${marginClass} ${overflowClass} ${cardClassname} mui`}
        variant={variant}
        elevation={elevation}
        {...rest}
      >
        <MuiCardContent {...cardContentProps}>
          {isCardHeader && (
            <MuiCardHeader
              ...
              classes={{
                title: `jv-mCard-header-title ${cardHeaderClasses} mui`,
              }}
              title={title}
              {...restCardHeaderProps}
            />
          ...
          {paddedCardBodyContent && (
            <div className="jv-mCard-bodyPadded jv-mCard-body mui">
              {" "}
              {paddedCardBodyContent}{" "}
            </div>
          )}
          {children && <div className="jv-mCard-body mui">{children}</div>}
        </MuiCardContent>
      </MuiCard>
    );
  },
