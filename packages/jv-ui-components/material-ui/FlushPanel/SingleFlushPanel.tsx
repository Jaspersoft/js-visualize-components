...
export const SingleFlushPanel: FC<SingleFlushPanelProps> = ({
  ...
  const closePanelLabel = i18nLabel(
    "materialUi.component.collapsiblePanel.close",
  );
  const iconDirection =
    anchor === "right" ? "caretRightLarge" : "caretLeftLarge";
  ...
  return (
    ...
    >
      <div className="jv-mPanel-header mui">
        {anchor === "right" && (
          <p className="jv-MuiTypography-root jv-mText jv-mPanel-header-title mui jv-MuiTypography-body1">
            {label}
          </p>
        )}
      ...
      <div className="jv-mPanel-body mui">{content}</div>
    </Drawer>
  );
};
